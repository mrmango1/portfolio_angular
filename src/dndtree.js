function createTree() {
  treeJSON = d3.json('./assets/flare.json', function (treeData) {
    ...
    function pan(domNode, direction = 'left') {
      if (!(domNode instanceof HTMLElement)) {
        throw new TypeError('The first argument must be an HTML element.');
      }
      ...
      if (panTimer) {
        ...
        if (direction === 'left' || direction === 'right') {
          ...
          translateY += (direction === 'up' ? speed : -speed);
        }
